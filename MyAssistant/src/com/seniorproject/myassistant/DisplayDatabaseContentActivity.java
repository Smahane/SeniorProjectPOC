...
public class DisplayDatabaseContentActivity extends ListActivity {
	...
	Intent intent;
	TextView contactId;
	ContactListActivity contactList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_database_output); 
		...
		if (contactList.size() != 0) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent theIndent = new Intent(getApplication(), ContactListActivity.class);
			...
			ListAdapter adapter = new SimpleAdapter(DisplayDatabaseContentActivity.this,
					contactList, R.layout.activity_contact_entry , new String[] {
							"contactId", "name" }, new int[] {
							R.id.contactId, R.id.contactName});
	...
	public void showAddContact(View view) {
		Intent theIntent = new Intent(getApplication(), ContactListActivity.class);
